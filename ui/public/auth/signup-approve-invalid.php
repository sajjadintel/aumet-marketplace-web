			...
			<div class="d-flex flex-row-fluid flex-center">
				...
				<div id="main" class="login-form login-form-signup">
					<div class="pb-10 pb-lg-15">
						<h3 class="font-weight-bolder text-dark display5"><?php echo $vSignup_isApprovedInvalidTitle ?></h3>
						<div class="text-dark-50 font-weight-bold font-size-h4"><?php echo htmlspecialchars_decode($vSignup_isApprovedInvalidSubtitle); ?></div>
