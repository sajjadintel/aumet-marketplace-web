        ...
        <div class="login-content flex-column-fluid d-flex flex-column p-10">
            ...
            <div class="d-flex flex-row-fluid flex-center">
                ...
                <div class="login-form">
                    <!--begin::Form-->
                    <form class="form" id="kt_login_forgot_form" action="/web/auth/forgot">
                        <!--begin::Title-->
                        <div class="pb-5 pb-lg-15">
                            <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg"></h3>
                            <p class="text-muted font-weight-bold font-size-h4"><?php echo $vForgot_enterPassword ?></p>
                        </div>
                        <!--end::Title-->
                        <!--begin::Form group-->
                        ...
                        <div class="form-group d-flex flex-wrap">
                            <button type="submit" id="kt_login_forgot_form_submit_button" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4"><?php echo $vForgot_submit ?></button>
                            <a href="/web/auth/signin" class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3"><?php echo $vForgot_cancel ?></a>
                        </div>
                        <!--end::Form group-->
                    </form>
                    <!--end::Form-->
