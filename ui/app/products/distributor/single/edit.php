<div class="px-5">
    <div class="card card-custom gutter-b">
        <div class="card-body">
            <h1 class="pb-2"><?php echo $vModule_product_editing . " '$product->name'"; ?></h1>
            <h4><?php echo $vModule_product_editingInfo; ?></h4>
        </div>
    </div>
    <div class="d-flex">
    ...
    <div class="card card-custom gutter-b">
        <div class="card-body">
                ...
                <form method="POST" action="/web/distributor/product/general" id="generalForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select class="select2 form-control" name="scientificNameId" id="scientificName" data-select2-id="scientificName" tabindex="-1" aria-hidden="true" autocomplete="off" data-scientificName="<?php echo $product->scientificName; ?>" data-scientificNameId="<?php echo $product->scientificNameId; ?>">
                            </select>
                        </div>
                        <div class="col-md-6 form-group">
                            <label for="country" class="form-control-label"><?php echo $vModule_product_madeIn; ?></label>
                            <select class="select2 form-control" name="countryId" id="country" data-select2-id="country" tabindex="-1" aria-hidden="true" autocomplete="off" data-countryName="<?php echo $product->madeInCountryName; ?>" data-countryId="<?php echo $product->madeInCountryId; ?>">
                            </select>
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="hidden" name="activeIngredientsId" id="activeIngredientsId" autocomplete="off" data-arrActiveIngredients="<?php echo htmlspecialchars(json_encode($arrActiveIngredients), ENT_QUOTES, 'UTF-8'); ?>"/>
                        </div>
                    </div>
            ...
            <div id="images-body" class="tab-body d-none">
                <form method="POST" action="/web/distributor/product/images" id="imagesForm">
                    <input type="hidden" name="productId" value="<?php echo $product->productId; ?>">
                    ...
                    <div class="row">
                        <div class="col-md-3 form-group">
                            <div class="image-input image-input-empty image-input-outline">
                                ...
                                <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                    ...
                                    <input type="file" name="profile_avatar" accept=".png, .jpg, .jpeg" id="image" autocomplete="off" data-value="<?php echo $product->image; ?>"/>
                        ...
                        <div class="col-md-3 form-group">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="imageAlt" id="imageAlt" autocomplete="off" value="<?php echo $product->imageAlt; ?>" placeholder="<?php echo $vModule_product_imageAltPlaceholder; ?>">
                            </div>
                            <div class="pt-5">
                    ...
                    <div class="row">
                        <div class="col-md-10 form-group">
                            ...
                            <input type="hidden" name="subimages" id="subimages" data-arrSubimages="<?php echo htmlspecialchars(json_encode($arrSubimages), ENT_QUOTES, 'UTF-8'); ?>"/>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end">
                        <button id="imagesSubmitButton" type="submit" class="btn btn-primary px-10 font-weight-bold"><?php echo $vModule_product_saveChanges; ?></button>
                    </div>
                </form>
            </div>
