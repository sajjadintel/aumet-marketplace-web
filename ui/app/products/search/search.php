        ...
        var columnDefs = [{
            ...
            }, */
            {
                ...
                render: function(data, type, row, meta) {
                    ...
                    var btnGoToCartMore =
                        '<a style="display: flex;" href="javascript:;" onclick=\'WebApp.loadPage("/web/cart/checkout")\' class="btn btn-sm btn-primary btn-text-primary btn-hover-primary  mr-2 mb-2" title="Go to cart">\
                        <span class="svg-icon svg-icon-md">\
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                            <rect x="0" y="0" width="24" height="24"/>\
                    ...
                    var btnGoToCart =
                        '<a style="display: flex;" href="javascript:;" onclick=\'WebApp.loadPage("/web/cart/checkout")\' class="btn btn-sm btn-default btn-text-primary btn-hover-primary  mr-2 mb-2" title="Go to cart">\
                        <span class="svg-icon svg-icon-md">\
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                            <rect x="0" y="0" width="24" height="24"/>\
