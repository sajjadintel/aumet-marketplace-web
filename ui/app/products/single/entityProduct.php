            ...
            <div class="card card-custom gutter-b">
                <div class="card-header border-0 py-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-primary"><?php echo $objEntityProduct->{"productName_" . $_SESSION['userLang']} ?></span>
                ...
                <div class="card-body d-flex rounded  p-12 flex-column flex-md-row flex-lg-column flex-xxl-row">
                    ...
                    <div class="card card-custom w-auto w-md-300px w-lg-auto w-xxl-400px ml-auto">
                        ...
                        <div class="card-body px-12 py-10 bg-primary">
                            ...
                            <div class="text-light font-size-h4 mb-9"><?php echo $objEntityProduct->unitPrice . ' ' . $objEntityProduct->currency ?></div>
                ...
                <div class="card-body py-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_4">
                            <thead>
                                <tr>
                                    <th class=""><?php echo $vModule_product_name ?></th>
                                    <th class=""><?php echo $vModule_product_distributor ?></th>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($arrRelatedEntityProduct as $objItem) : ?>
                                    <?php if($objUser->menuId !== 1 || array_key_exists((string) $objItem->entityId, $_SESSION['arrEntities'])) :?>
                                    <tr>
                                        <td class=" align-middle font-weight-bolder font-size-h5">
                                            <a href="javascript:;" onclick="WebApp.loadSubPage('/web/entity/<?php echo $objItem->entityId ?>/product/<?php echo $objItem->productId ?>')" class="text-dark text-hover-primary">
                                                <div style="display: flex;flex-direction: row;align-items: center">
                                                    ...
                                                    <span><?php echo $objItem->{"productName_" . $_SESSION['userLang']} ?></span>
                                                </div>
                                            </a>
                                        </td>

                                        <td class="align-middle font-weight-bolder font-size-h5"><?php echo $objItem->{"entityName_" . $_SESSION['userLang']} ?></td>
    ...
    function setUpButtons() {
        /*
                    var btnAddMoreToCart =
                        '<a href="javascript:;" onclick=\'setUpButtons(++cart);SearchDataTable.onClickAddMoreToCart(' +
                        JSON.stringify(row) +
                    ...
                    var btnAddToCart =
                        '<a href="javascript:;" onclick=\'setUpButtons(++cart);SearchDataTable.onClickAddToCart(' +
                        JSON.stringify(row) +
