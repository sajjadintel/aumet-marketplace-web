...
<head>
    ...
    <?php include_once 'ui/app/layout/seoHead.php' ?>
...
<body id="kt_body" class="header-fixed header-mobile-fixed  aside-enabled aside-fixed aside-minimize-hoverable aside-minimize page-loading ">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W5PTNF7"
    ...
    <script>
        jQuery(document).ready(function() {
            WebApp.init();
            credentials = '<?php json_encode(['apiKey' => getenv('FCM_API_KEY'), 'authDomain' => getenv('FCM_AUTH_DOMAIN'), 'projectId' => getenv('FCM_PROJECT_ID'), 'storageBucket' => getenv('FCM_STORAGE_BUCKET'), 'messagingSenderId' => getenv('FCM_MESSAGING_SENDER_ID'), 'appId' => getenv('FCM_APP_ID')]) ?>'
