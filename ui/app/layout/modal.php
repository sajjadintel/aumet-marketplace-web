...
<div class="modal fade" id="welcomeModal" data-backdrop="static" data-login-counter="<?php echo $objUser->loginCounter ?>" tabindex="-1" role="dialog" aria-labelledby="welcomeModalLabel" aria-hidden="true">
