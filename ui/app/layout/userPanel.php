        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="navi mt-2">
                    ...
                    <a href="/web/auth/signout"  class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5" onclick="dataLayer.push({'event': 'logout','method': 'email'});"><?php echo $vLogin_signout ?></a>
                </div>
            </div>
        </div>
        <!--end::Header-->
