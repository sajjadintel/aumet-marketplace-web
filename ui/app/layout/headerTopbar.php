<div class="topbar">
	...
	<div class="dropdown">
		...
		<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
			<!--begin:Header-->
			<div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(/theme/assets/media/misc/bg-1.jpg)">
	...
	-->
	<div class="topbar-item" id="cartTopBarItem">

		<div class="btn btn-icon w-auto btn-clean d-inline-flex align-items-center btn-lg px-2 mr-5" onclick="Cart.loadCartPage()" id="cartTopBarItemButton">
			<span class="label label-lg font-weight-boldest  px-2 mr-1 pulse-primary" id="cartTopBarItemTextContainer">
				<span class="position-relative" id="cartTopBarItemText"></span>
				<span class="pulse-ring"></span>
			</span>
			<span class="svg-icon svg-icon-xl svg-icon-light" id="cartTopBarItemSvgIcon">
				<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
					<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
						<rect x="0" y="0" width="24" height="24" />
						<path d="M12,4.56204994 L7.76822128,9.6401844 C7.4146572,10.0644613 6.7840925,10.1217854 6.3598156,9.76822128 C5.9355387,9.4146572 5.87821464,8.7840925 6.23177872,8.3598156 L11.2317787,2.3598156 C11.6315738,1.88006147 12.3684262,1.88006147 12.7682213,2.3598156 L17.7682213,8.3598156 C18.1217854,8.7840925 18.0644613,9.4146572 17.6401844,9.76822128 C17.2159075,10.1217854 16.5853428,10.0644613 16.2317787,9.6401844 L12,4.56204994 Z" fill="#000000" fill-rule="nonzero" opacity="0.3" />
