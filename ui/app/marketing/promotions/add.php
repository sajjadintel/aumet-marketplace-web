<div class="px-10 d-flex justify-content-center">
    <form method="POST" action="/web/distributor/marketing/promotion/add" id="promotionForm" class="single-promotion-form">
        <div class="row">
            <div class="col-md-12 form-group">
                <label for="name" class="form-control-label h3 font-weight-bolder"><?php echo $vModule_promotion_name; ?></label>
                <input type="text" class="form-control" name="name" id="name" placeholder="<?php echo $vModule_promotion_name; ?>">
            </div>
        </div>
            ...
            <div class="col-md-12 form-group">
                ...
                <div class="d-flex align-items-center">
                    <div class="input-group date">
                        <input type="text" class="form-control" name="startDate" id="startDate" placeholder="<?php echo $vModule_promotion_start; ?>" readonly>
                    ...
                    <div class="input-group date">
                        <input type="text" class="form-control" name="endDate" id="endDate" placeholder="<?php echo $vModule_promotion_end; ?>" readonly>
                        <div class="input-group-append">
                            <span class="input-group-text">
                                <i class="la la-calendar"></i>
                            </span>
        ...
        <div class="form-group" id="featuredProductsRepeater">
            <div class="row">
                ...
                <div id="featuredProductsList" data-repeater-list="featuredProductsList" class="col-md-12" data-arrProducts="<?php echo htmlspecialchars(json_encode($arrProducts), ENT_QUOTES, 'UTF-8'); ?>">
        ...
        <div class="row">
            <div class="col-md-12 form-group">
                ...
                <textarea type="text" class="single-promotion-textarea form-control" name="message" id="message" rows="4" placeholder="<?php echo $vModule_promotion_message; ?>"></textarea>
            </div>
        </div>
        <div class="d-flex justify-content-end">
            <button id="promotionSubmitButton" type="submit" class="btn btn-primary px-10 font-weight-bold"><?php echo $vModule_promotion_add; ?></button>
        </div>
    </form>
</div>
<script>
