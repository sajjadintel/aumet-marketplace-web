...
var Cart = function () {
    ...
    var _int = function () {
        ...
        WebApp.get("/app/cart/status", _getCartStatusCallback);
    };
    ...
    var _addItem = function (entityId, productId, quantityInputId = null) {
        ...
        WebApp.post("/app/cart/add", { entityId: entityId, productId: productId, quantity: (quantityInputId == null ? 1 : $(quantityInputId).val()) }, _addItemSuccessCallback);
    };

    var _removeItem = function (id) {
        WebApp.post("/app/cart/remove", { id: id }, _removeItemSuccessCallback);
    };
