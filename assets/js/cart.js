...
var Cart = (function () {
	...
	var _addItem = function (entityId, productId, quantityInputId = null, quantityFreeInputId = null, submitButton = null, forceCallback = false, forcePreventUnblur = false, fromProductPage = false) {
		if (_itemsCount <= 0) {
			_topBarItemSvgIcon.removeClass(_svgIconNoColor_NoItems).addClass(_svgIconNoColor_Items);
			_topbarItemTextContainer.addClass(_addPulse).addClass(_addPulseColor);
			_topbarItemText.show();
